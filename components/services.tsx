...
export default function Services() {
  ...
  const toggleService = (serviceId: string) => {
    // Close all others and toggle the selected one
  ...
  return (
    <section id="services" className="container max-w-screen-2xl py-24 bg-white">
      ...
      <div className="grid gap-8 md:grid-cols-3">
        {/* Guest Tablet Card */}
        <Card className="border border-gray-200 bg-white hover:shadow-lg transition-all duration-300 cursor-pointer">
          <CardHeader onClick={() => toggleService("guest-tablet")} className="pb-4">
        ...
        {/* Staff App Card */}
        <Card className="border border-gray-200 bg-white hover:shadow-lg transition-all duration-300 cursor-pointer">
          <CardHeader onClick={() => toggleService("staff-app")} className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
        ...
        <Card className="border border-gray-200 bg-white hover:shadow-lg transition-all duration-300 cursor-pointer">
          <CardHeader onClick={() => toggleService("manager-dashboard")} className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
